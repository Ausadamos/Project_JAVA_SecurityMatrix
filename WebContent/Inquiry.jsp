...
<aside class="menu">
  ...
  <div class="tile is-parent">
    <div class="tile is-child box">
      <i class="fas fa-user fa-2x fa-pull-left fa-border"></i><p class="title">INQUIRY PROFILE</p>
      
      <hr>
      <form action="InquiryProfileServlet" method="post">
