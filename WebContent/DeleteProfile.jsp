...
<%if(Integer.parseInt(status) == 00){
  ...
  <div class="tile is-parent">
    <div class="tile is-child box">
      <i class="fas fa-trash fa-2x fa-pull-left fa-border"></i>   <p class="title">DELETE PROFILE</p>
      <hr>
      
      <form action="DeleteProfileServlet" method="post" id="from3">
